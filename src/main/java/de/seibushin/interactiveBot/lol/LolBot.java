...
import de.seibushin.interactiveBot.lol.model.Steps;
...
public class LolBot {
    ...
    private static LolBot instance;
     ...
     * @return
     */
    public synchronized static LolBot getInstance() {
        if (instance == null) {
            instance = new LolBot();
        }
        return instance;
