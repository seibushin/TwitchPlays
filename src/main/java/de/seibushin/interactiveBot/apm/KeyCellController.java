...
import de.seibushin.interactiveBot.apm.model.KeyTranslate;
...
public class KeyCellController {
    ...
    public void setInfo(Key key) {
        keyChar.setText(KeyTranslate.getTranslation(key.getKeycode(), key.getKeychar()));

        //keyChar.setText(key.getKeychar());
        //time.setText(key.getDelta() + "");
    }
